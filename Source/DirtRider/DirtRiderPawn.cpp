...
#include "DirtRiderWheelFront.h"
#include "DirtRiderWheelRear.h"
...
ADirtRiderPawn::ADirtRiderPawn()
{
	...
	Vehicle4W->WheelSetups[0].WheelClass = UDirtRiderWheelFront::StaticClass();
	Vehicle4W->WheelSetups[0].BoneName = FName("Wheel_Front_Left");
	Vehicle4W->WheelSetups[0].AdditionalOffset = FVector(0.f, -12.f, 0.f);

	Vehicle4W->WheelSetups[1].WheelClass = UDirtRiderWheelFront::StaticClass();
	Vehicle4W->WheelSetups[1].BoneName = FName("Wheel_Front_Right");
	Vehicle4W->WheelSetups[1].AdditionalOffset = FVector(0.f, 12.f, 0.f);

	Vehicle4W->WheelSetups[2].WheelClass = UDirtRiderWheelRear::StaticClass();
	Vehicle4W->WheelSetups[2].BoneName = FName("Wheel_Rear_Left");
	Vehicle4W->WheelSetups[2].AdditionalOffset = FVector(0.f, -12.f, 0.f);

	Vehicle4W->WheelSetups[3].WheelClass = UDirtRiderWheelRear::StaticClass();
...
void ADirtRiderPawn::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void ADirtRiderPawn::OnHandbrakeReleased()
{
	GetVehicleMovementComponent()->SetHandbrakeInput(false);
}

void ADirtRiderPawn::OnToggleCamera()
{
	EnableIncarView(!bInCarCameraActive);
}

void ADirtRiderPawn::EnableIncarView(const bool bState, const bool bForce)
{
...
void ADirtRiderPawn::Tick(float Delta)
{
	Super::Tick(Delta);
...
void ADirtRiderPawn::SetupInCarHUD()
{
